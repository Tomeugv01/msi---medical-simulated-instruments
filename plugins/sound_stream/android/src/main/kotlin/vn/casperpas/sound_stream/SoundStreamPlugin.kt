...
public class SoundStreamPlugin : FlutterPlugin,
    ...
    private var mRecorderBufferSize = 16384
    ...
    private var mPlayerBufferSize = 16384
    ...
    @SuppressLint("MissingPermission")
    	...
    	mRecorder = AudioRecord(
        	MediaRecorder.AudioSource.CAMCORDER,  // <-- CHANGED TO CAMCORDER
        	mRecordSampleRate,
        	AudioFormat.CHANNEL_IN_MONO,
       		mRecordFormat,
        	mRecorderBufferSize
    ...
    private fun initializePlayer(call: MethodCall, result: Result) {
        ...
        mAudioManager?.isSpeakerphoneOn = false   // ensures audio goes to earpiece/headset, not speaker
